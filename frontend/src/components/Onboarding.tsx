            ...
            <div className="flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <input 
                  ...
                  className="brutalist-border p-4 font-bold uppercase placeholder:opacity-30"
                  value={anthemTrackId}
                  onChange={(e) => setAnthemTrackId(e.target.value)}
                  required
                />
                <input 
                  type="text" 
                  placeholder="TRACK NAME"
                  className="brutalist-border p-4 font-bold uppercase placeholder:opacity-30 mt-[-10px]"
                  value={anthemName}
                  onChange={(e) => setAnthemName(e.target.value)}
                  required
                />
              </div>
            </div>
